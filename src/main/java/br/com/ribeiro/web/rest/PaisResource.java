...
public class PaisResource {
    ...
    public ResponseEntity<PaisDTO> updatePais(@RequestBody PaisDTO paisDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paisDTO.getId().toString()))
            .body(result);
    }
     ...
     */
    @GetMapping("/pais")
    public ResponseEntity<List<PaisDTO>> getAllPais(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
